...
otp.config = {
    ...
    hostname : "http://ec2-54-234-135-182.compute-1.amazonaws.com:8080",
    //routerId : <id>,
    ...
    // Daytime theme
    tileUrl : 'http://{s}.tiles.mapbox.com/v3/mikelockz.map-sxf48nmk/{z}/{x}/{y}.png',
    // Nightime theme
    // tileUrl : 'http://{s}.tiles.mapbox.com/v3/mikelockz.map-fvoz9mpk/{z}/{x}/{y}.png',
